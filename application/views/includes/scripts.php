...
<script type="text/javascript">
   ...
   $('#song_type1').on('change', function() {
        ...
        var song_type = $('select[id=song_type1]').val();

        $.ajax({
               type: "POST",
               url: base_url + "Song/load_songs",
               data: {singer_id : singer_id , song_type : song_type },
               cache: false,
               dataType: 'json',  
                beforeSend : function(){  
                       Swal.showLoading();
...
$('#song_type').on('change', function(e){
    ...
    var song_type = $('select[id=song_type]').val();
    ...
    $.ajax({
               ...
               success: function(data){
                       ...
                       $('.singer-song-table').html('Wala Yamo');
                   }
               },
               error : function(data){
